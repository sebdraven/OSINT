...
class search(threading.Thread):
    ...
    def record(self):
        ...
        for domaine in domaines:
            ...
            if entry == None:
                self.db.new_domaines.insert_one({'domaine':domaine,'urls':self.urls_by_domaine[domaine],'criteria':[self.criteria]})
            else:
                ...
                try:
                    ...
                    entry['criteria']=criteria
                    try:
                        self.db.new_domaines.insert_one({'domaine':domaine},{'urls':self.urls_by_domaine[domaine],'criteria':criteria})
                    except:
                        pass
